...
class ApiService {
  ...
  void _setupInterceptors() {
    ...
    if (kDebugMode) {
      dio.interceptors.add(
        LogInterceptor(requestBody: true, responseBody: true, logPrint: (obj) => debugPrint(obj.toString())),
      );
    }
  }
  ...
  Future<Response<Map<String, dynamic>>> markPhoneVerified({required String phoneNumber}) {
    return dio.post<Map<String, dynamic>>('/api/users/me/verification/phone', data: {'phoneNumber': phoneNumber});
  }
}
